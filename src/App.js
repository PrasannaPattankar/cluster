...
function App() {
  ...
  return transactionData == null ? (
    ...
    <div>
      <div className="container">
        <div className="row">
          <div className="col-10">
            <h2>Reward Points Collected by Customers for the Months</h2>
          </div>
        </div>
        <div className="row">
          <div className="col-8">
      ...
      <center>Note: Testing the another case Add Input transaction into /src/api/dataService.js</center>
    </div>
  );
}
